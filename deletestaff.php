...
$bkdetails="select * from staffinfo where firstname='$getfname' and lastname='$getlname' ";
...
while($res = mysql_fetch_array($count))
{
  ...
  $getcontactno=$res['contactno'];
  $getstate=$res['state'];
  $getcity=$res['city'];
  $getaddress=$res['address'];
  $getgender=$res['gender'];
  $getdesignation=$res['designation'];
  $getduty=$res['duty'];
  $getsalary=$res['salary'];
}
$insertintobk="insert into backupstaff values('$getadhar','$getfirstname','$getlastname','$getcontactno','$getstate','$getcity','$getaddress','$getgender','$getdesignation','$getduty','$getsalary')";
mysql_query($insertintobk) or die("<script language='javascript'>alert('ERROR IN PROCESS.');</script>");

$query="delete from staffinfo where firstname='$getfname' and lastname='$getlname' ";
mysql_query($query) or die("<script language='javascript'>alert('ERROR IN PROCESS.');</script>");
