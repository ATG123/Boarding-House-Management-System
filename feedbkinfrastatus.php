...
?>
<br><br>
<h3>STATUS OF FEEDBACK RECEIVED IN CASE OF INFRASTRUCTURE ISSUES</h3>
<br><br>
...
<tr rowspan="5">
<th>INFRASTRUCTURE ISSUES STATUS : </th>
<td>5 POINTS : </td>
<td><?php echo $i5; ?></td>
<td><?php echo round(($i5*100/$count),2);echo "%"; ?></td>
</tr>
...
<td>4 POINTS : </td>
<td><?php echo $i4; ?></td>
<td><?php echo round(($i4*80/$count),2);echo "%"; ?></td>
</tr>
...
<td>3 POINTS : </td>
<td><?php echo $i3; ?></td>
<td><?php echo round(($i3*60/$count),2);echo "%"; ?></td>
</tr>
...
<td>2 POINTS : </td>
<td><?php echo $i2; ?></td>
<td><?php echo round(($i2*40/$count),2);echo "%"; ?></td>
</tr>
...
<td>1 POINTS : </td>
<td><?php echo $i1; ?></td>
<td><?php echo round(($i1*20/$count),2);echo "%"; ?></td>
</tr>
</table>
<br><br>
<?php
$status = round(($i5*100/$count),2) + round(($i4*80/$count),2) + round(($i3*60/$count),2) + round(($i2*40/$count),2) + round(($i1*20/$count),2);
