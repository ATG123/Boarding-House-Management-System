...
$getcomplaintid=$_GET["complaint"];
$_SESSION["diffcid"]=$getcomplaintid;

 $getadhar=$_SESSION["getadhar"];
 echo "getadhar : ";
 echo $getadhar;
 echo "<br>";
...
$query="update complaintbox set resolvedstatus='RESOLVED' where roomno='$room' and bedno='$bed' and complaintid='$getcomplaintid' ";
mysql_query($query) or die("Error, Update Query Failed");

echo "<br>";
echo "closing connections";
mysql_close($connection);
echo "<script language='javascript'>document.location='viewprevcomplaints.php';</script>";
?>
</div>
