...
<form action="pmessstatus.php"  method="post">
<h3>STATUS OF MESS FACILITY USED BY STUDENTS</h3>
...
$query = "select firstname,lastname,f.roomno,f.bedno,month,messamt from basicformfill b,facilities f,notifyuser n where b.adhar=n.adhar and display='student' and f.roomno=n.roomno and f.bedno=n.bedno";
...
<a href="respmonthmessstatus.php">SEE CORRESPONDING MONTHLY STATUS</a>
</div>
</body>
</html>
