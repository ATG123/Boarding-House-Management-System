...
<h4>SELECT THE NAME OF THE STUDENT WHOSE COMPLETE DETAILS YOU WANT TO SEE</h4>
<form action="completestudinfonext.php" method="post">
<?php
include 'justdefine.php';
include 'connect.php';
$query = "select * from basicformfill where display='student'";
...
?>
<br>
<input type="submit" name="ttsearch" value="VIEW DETAILS"></p>
</form>
