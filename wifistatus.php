...
<form action="pwifistatus.php"  method="post">
<br>
<h3>STATUS OF WIFI FACILITY USED BY STUDENTS</h3>
...
$query = "select firstname,lastname,f.roomno,f.bedno,month,wifiamt from basicformfill b,facilities f,notifyuser n where b.adhar=n.adhar and display='student' and f.roomno=n.roomno and f.bedno=n.bedno";
...
echo $totalwifiprofit;
?>
<br><br>
<h3>SELECT THE MONTH TO SEE THE MONTH WISE PROFIT</h3>
...
<a href="respmonthwifistatus.php">SEE CORRESPONDING MONTHLY STATUS</a>
</div>
</body>
</html>
