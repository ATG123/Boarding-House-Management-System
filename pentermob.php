...
<fieldset>
<!-- Form Name -->
<legend><b>OTP GENERATION AND FILLING</b></legend><br>
...
echo "<br>";
   ...
   echo $r;
   $_SESSION["numrandom"]=$r;
   echo "<br>";
   echo "RANDOM NUMBER GENERATED STORED IN SESSION VARIABLE : ";
   echo $_SESSION["numrandom"];
   echo "<br>";
   echo "<script type='text/javascript'>alert('OTP IS .$r.')</script>";
   echo "<br>";
?>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label">Otp Number</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="otp" placeholder="Otp Number" class="form-control"  type="text">
    </div>
  </div>
</div>
<br>
