...
{
$updadhar=$_SESSION["adhar"];
$updcontact=$_POST["contact"];

$updstate=$_POST["state"];
$updcity=$_POST["city"];
$updaddress=$_POST["address"];

$upddesignation=$_POST["designation"];
$updduty=$_POST["duty"];
$updsalary=$_POST["salary"];


if(isset($_POST["update"]))
{
$query = "UPDATE STAFFINFO SET contactno='$updcontact',state='$updstate',city='$updcity',address='$updaddress',designation='$upddesignation',duty='$updduty',salary='$updsalary' WHERE adhar='$updadhar'";
echo "<br>";
echo "<h2>" . $query;
echo "<br>";
