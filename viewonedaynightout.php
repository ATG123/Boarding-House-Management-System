...
<div class="container" style="width:45%;margin-left: 350px;margin-top: 75px;border-radius: 15px; border:3;opacity:0.85;">
<h3>RECORD OF STUDENTS ON NIGHT OUT FOR ONLY ONE DAY</h3>
<table  border="4"  cellpadding="8" align="center" bordercolor="#C65000" style="text-align:center">
<tr>
<th>ROOM NUMBER</th>
<th>BED NUMBER</th>
<th>DATE OF NIGHT OUT</th>
</tr>
<?php
include 'justdefine.php';
include 'connect.php';

$pquery = "select * from onedaynightout";
...
<th><?php echo $res['nightoutdate'];?></th>
</tr>
<?php
}
