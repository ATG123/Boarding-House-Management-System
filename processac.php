...
include 'connect.php';
echo "<br><br>";
$comp=$_GET['getcompletedetails'];
$len=strlen($comp);

$getadhar=substr($comp,0,14);
$_SESSION["adhar"]=$getadhar;

$gettypeofroom=substr($comp,15,-9);
$_SESSION["typeofroom"]=$gettypeofroom;

$getsubtype=substr($comp,-8);
$_SESSION["subtypeofroom"]=$getsubtype;

$nonac="NON AC ROOM";
$x=strcmp($gettypeofroom,$nonac);
if($x==0)
{
   echo "<script language='javascript'>document.location='processnonac.php';</script>";
}

$_SESSION["dispbuttons"]=$getsubtype;
...
if($sub==2)
$querytry="select * from acrooms where roomno in (4,5,6)";
else
if($sub==3)
$querytry="select * from acrooms where roomno in (7,8,9,10)";
...
if($sub==2)
{
     echo "<a href='one.php'><input type='submit' name='submit' value='1 SEATER'></a>";
     echo "<br><br>";
     echo "<a href='three.php'><input type='submit' name='submit' value='3 SEATER'></a>";
}
else
