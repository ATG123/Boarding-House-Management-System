...
<br>
<h3>STATUS OF AC ROOM 1 SEATER</h3>
<hr>
...
echo "</b>";
echo "<br><br>";
echo "<b>TOTAL PROFIT FROM AC ROOM ONE SEATER IS : </b>";
echo "<b style='font-size:24px;'>";
echo $count*82500;
echo "</b>";
?>
...
<div class="container" style="width:40%;margin-left:450px;margin-top: 75px;border-radius: 15px; border:3;opacity:0.85;">
<br>
<h3>STATUS OF AC ROOM 2 SEATER</h3>
<hr>
...
echo "</b>";
echo "<br><br>";
echo "<b>TOTAL PROFIT FROM AC ROOM TWO SEATER IS : </b>";
echo "<b style='font-size:24px;'>";
echo $count*77000;
echo "</b>";
?>
...
<div class="container" style="width:40%;margin-left:450px;margin-top: 75px;border-radius: 15px; border:3;opacity:0.85;">
<br>
<h3>STATUS OF AC ROOM 3 SEATER</h3>
<hr>
...
echo "</b>";
echo "<br><br>";
echo "<b>TOTAL PROFIT FROM  AC ROOM THREE SEATER IS : </b>";
echo "<b style='font-size:24px;'>";
echo $count*68200;
echo "</b>";
