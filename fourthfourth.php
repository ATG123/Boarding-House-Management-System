...
$query = "insert into staffinfo (adhar,firstname,lastname,contactno,state,city,address,gender,designation,duty,salary)  values('$adhar','$first_name','$last_name','$sphone','$state','$city','$address','$gender','$desgination','$duty','$sal')";
mysql_query($query) or die("<script language='javascript'>alert('ERROR IN FILLING THE FORM.');</script>");
echo "<script language='javascript'>alert('STAFF DETAILS HAVE BEEN SUCCESSFULLY TAKEN.');</script>";
