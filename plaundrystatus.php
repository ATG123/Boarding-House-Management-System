...
$query = "select firstname,lastname,f.roomno,f.bedno,month,laundryamt from basicformfill b,facilities f,notifyuser n where b.adhar=n.adhar and display='student' and f.roomno=n.roomno and f.bedno=n.bedno and month='$selmonth' ";

$temp=mysql_query($query) or die("Error,Query Failed");
$totalamtformonth=0;
while ($res = mysql_fetch_array($temp)) 
{
 $totalamtformonth=$totalamtformonth+$res['laundryamt'];
?>
<tr>
