...
<br><br>
<h3>STATUS OF FEEDBACK RECEIVED IN CASE OF OTHER ISSUES</h3>
<br><br>
...
<tr rowspan="5">
<th>OTHER ISSUES STATUS : </th>
<td>5 POINTS : </td>
<td><?php echo $o5; ?></td>
<td><?php echo round(($o5*20/$count),2);echo "%"; ?></td>
</tr>
...
<td>4 POINTS : </td>
<td><?php echo $o4; ?></td>
<td><?php echo round(($o4*80/$count),2);echo "%"; ?></td>
</tr>
...
<td>3 POINTS : </td>
<td><?php echo $o3; ?></td>
<td><?php echo round(($o3*60/$count),2);echo "%"; ?></td>
</tr>
...
<td>2 POINTS : </td>
<td><?php echo $o2; ?></td>
<td><?php echo round(($o2*40/$count),2);echo "%"; ?></td>
</tr>
...
<td>1 POINTS : </td>
<td><?php echo $o1; ?></td>
<td><?php echo round(($o1*20/$count),2);echo "%"; ?></td>
</tr>
</table>
<br><br>
<?php
$status = round(($o5*100/$count),2) + round(($o4*80/$count),2) + round(($o3*60/$count),2) + round(($o2*40/$count),2) + round(($o1*20/$count),2);
