...
?>
<br><br>
<h3>STATUS OF FEEDBACK RECEIVED IN CASE OF ELECTRICAL ISSUES</h3>
<br><br>
...
<tr rowspan="5">
<th>ELECTRICAL ISSUES STATUS : </th>
<td>5 POINTS : </td>
<td><?php echo $e5; ?></td>
<td><?php echo round(($e5*100/$count),2);echo "%"; ?></td>
</tr>
...
<td>4 POINTS : </td>
<td><?php echo $e4; ?></td>
<td><?php echo round(($e4*80/$count),2);echo "%"; ?></td>
</tr>
...
<td>3 POINTS : </td>
<td><?php echo $e3; ?></td>
<td><?php echo round(($e3*60/$count),2);echo "%"; ?></td>
</tr>
...
<td>2 POINTS : </td>
<td><?php echo $e2; ?></td>
<td><?php echo round(($e2*40/$count),2);echo "%"; ?></td>
</tr>
...
<td>1 POINTS : </td>
<td><?php echo $e1; ?></td>
<td><?php echo round(($e1*20/$count),2);echo "%"; ?></td>
</tr>
</table>
<br><br>
<?php
$status = round(($e5*100/$count),2) + round(($e4*80/$count),2) + round(($e3*60/$count),2) + round(($e2*40/$count),2) + round(($e1*20/$count),2);
