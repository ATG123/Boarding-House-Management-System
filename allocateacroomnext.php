...
{
$querystatus=" update acrooms set status='Blocked' where roomno='$getroomnum' and bedno='$getbednum'";
...
echo "<br>";
$failurequery="update acrooms set status='Not Booked' where roomno='$getroomnum' and bedno='$getbednum' ";
