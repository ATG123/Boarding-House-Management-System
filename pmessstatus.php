...
<table  border="7"  cellpadding="3" cellspacing="3" align="center" bordercolor="#C65000" style="text-align:center">
<tr>
<th>FIRST NAME</th>
<th>LAST NAME</th>
<th>ROOM NUMBER</th>
...
$query = "select firstname,lastname,f.roomno,f.bedno,month,messamt from basicformfill b,facilities f,notifyuser n where b.adhar=n.adhar and display='student' and f.roomno=n.roomno and f.bedno=n.bedno and month='$selmonth' ";
...
echo $selmonth;
echo "<br>";
echo "AMOUNT RECEIVED IS : ";
echo $totalamtformonth;
?>
</div>
</body>
</html>
