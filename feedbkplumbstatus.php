...
?>
<br><br>
<h3>STATUS OF FEEDBACK RECEIVED IN CASE OF PLUMBING ISSUES</h3>
<br><br>
...
<tr rowspan="5">
<th>PLUMBING ISSUES STATUS : </th>
<td>5 POINTS : </td>
<td><?php echo $p5; ?></td>
<td><?php echo round(($p5*100/$count),2);echo "%"; ?></td>
</tr>
...
<td>4 POINTS : </td>
<td><?php echo $p4; ?></td>
<td><?php echo round(($p4*80/$count),2);echo "%"; ?></td>
</tr>
...
<td>3 POINTS : </td>
<td><?php echo $p3; ?></td>
<td><?php echo round(($p3*60/$count),2);echo "%"; ?></td>
</tr>
...
<td>2 POINTS : </td>
<td><?php echo $p2; ?></td>
<td><?php echo round(($p2*40/$count),2);echo "%"; ?></td>
</tr>
...
<td>1 POINTS : </td>
<td><?php echo $p1; ?></td>
<td><?php echo round(($p1*20/$count),2);echo "%"; ?></td>
</tr>
</table>
<br><br>
<?php
$status = round(($p5*100/$count),2) + round(($p4*80/$count),2) + round(($p3*60/$count),2) + round(($p2*40/$count),2) + round(($p1*20/$count),2);
