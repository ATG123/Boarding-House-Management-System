...
$gettypeofroom=$_SESSION["typeofroom"];
$getsubtype=$_SESSION["subtypeofroom"];
...
if($sub==1)
$querytry="select * from nonacrooms where roomno in (11,12,13)";
else
if($sub==2)
$querytry="select * from nonacrooms where roomno in (14,15,16)";
else
if($sub==3)
$querytry="select * from nonacrooms where roomno in (17,18,19,20)";
...
?>
  <tr>
     <td><a href="allocatenonacroomnext.php?roombedno=<?php echo  $res['roomno']; ?>,<?php echo $res['bedno'];?>" <?php if($flag==0) echo $decide; ?>>SELECT</a></td>
...
<br>
<p>SEE THE STATUS OF : </p>
<?php
if($sub==1)
  {
     echo "<a href='twotwo.php'><input type='submit' name='submit' value='2 SEATER'></a>";
     echo "<br><br>";
     echo "<a href='threethree.php'><input type='submit' name='submit' value='3 SEATER'></a>";
  }
else
if($sub==2)
{
     echo "<a href='oneone.php'><input type='submit' name='submit' value='1 SEATER'></a>";
     echo "<br><br>";
     echo "<a href='threethree.php'><input type='submit' name='submit' value='3 SEATER'></a>";
}
else
